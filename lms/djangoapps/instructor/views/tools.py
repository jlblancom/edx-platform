...
def bulk_email_is_enabled_for_course(course_id):
    ...
    bulk_email_enabled_globally = settings.FEATURES['ENABLE_INSTRUCTOR_EMAIL']
    ...
    if bulk_email_enabled_globally and is_studio_course and bulk_email_enabled_for_course(course_id):
        return True
