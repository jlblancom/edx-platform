        ...
        describe("Container View", function () {
            ...
            describe("Supports reordering components", function () {
                ...
                it('can reorder within a group', function () {
                    var requests = init(this);
                    // Drag the first component in Group A to after the third component
                    dragComponentBelow(groupAComponent1, groupAComponent3);
                ...
                it('can drag from one group to another', function () {
                    var requests = init(this);
                    // Drag the first component in Group A to the second group.
                    dragComponentAbove(groupAComponent1, groupBComponent2);
                    // dragComponentVertically(groupAComponent1, 200);
                    respondToRequest(requests, 0, 200);
                    ...
                    verifyRequest(requests, 0, groupBUrl,
                        [groupBComponent1, groupAComponent1, groupBComponent2, groupBComponent3]);
                ...
                it('can drag a component to the top level', function () {
                    var requests = init(this);
                    // Drag first item in Group A to the top level (in first position).
                    dragComponentAbove(groupAComponent1, groupA);
                    respondToRequest(requests, 0, 200);
                    respondToRequest(requests, 1, 200);
                    verifyNumReorderCalls(requests, 2);
                ...
                // TODO: try to rewrite this test so that it works correctly
                xit('can nest one group in another', function () {
                    var requests = init(this);

                    // Drag Group A into Group B.
                    dragComponentBelow(groupA, groupBComponent1);
                    respondToRequest(requests, 2, 200);
                    respondToRequest(requests, 3, 200);
                    verifyNumReorderCalls(requests, 4);
                    verifyRequest(requests, 2, groupBUrl,
                        [groupA, groupBComponent1, groupBComponent2, groupBComponent3]);
